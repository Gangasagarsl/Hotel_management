...
class Cust_win:
  ...
  # ==================== title ============================
    ...
    # ==================== label frame ============================
    labelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="Customer Details",font=("arial",12,"bold"),padx=2,fg="black")
    ...
    combo_id["value"]=["Adharcard","DrivingLincence","Passport"]
    combo_id.current(0)
  ...
  # ==================== btns ============================
    ...
    self.Cust_Details_Table.heading("address",text="Id Number")
  ...
  def mDelete(self):
    mDelete=messagebox.askyesno("Hetel Management System","Do you want delete this customer",parent=self.root)
    if mDelete>0:
      conn=mysql.connector.connect(host="localhost",user="root",password="Ganga@#123",database="mydata")
      my_cursor=conn.cursor()
