...
class HotelManagementSystem:
  def __init__(self,root):
    ...
    # ==================== 1st img ============================
    img1=Image.open(r"D:\PROJECTS\hotel management\image\hotel")
    ...
    # ==================== manu ============================
    lbl_manu=Label(main_frame,text="MANU",font=("times new roman",20,"bold"),bg="black",fg="gold",bd=4,relief=RIDGE)
    ...
    # ==================== right side image ============================
    img3=Image.open(r"D:\PROJECTS\hotel management\image\side2")
    ...
    # ==================== down  images ============================
    img4=Image.open(r"D:\PROJECTS\hotel management\image\myh")
    ...
    img5=Image.open(r"D:\PROJECTS\hotel management\image\khana")
